        ...
        <>
            ...
            }
            {
                ...
                isMoviePlayerModalOpen && embeddedPlayerMovieId !== null && <Modal close={closeMoviePlayerModal} >
                    ...
                    <iframe id="ve-iframe" src={"https://www.2embed.to/embed/tmdb/movie?id=" + embeddedPlayerMovieId} width="100%" height="100%" allowFullScreen="allowfullscreen" frameBorder="0"></iframe>
                </Modal>
