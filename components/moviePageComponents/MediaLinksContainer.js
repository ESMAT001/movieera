                            ...
                            <li
                                ...
                                <div className="flex space-x-2">
                                    <a
                                        ...
                                        rel="noreferrer"
                                        download={true}
                                        className="font-semibold rounded antialiased bg-nice-red hover:bg-red-500 focus:bg-red-600 flex items-center justify-center gap-1 outline-none tracking-wider focus:outline-none focus:shadow-none transition-all duration-300 py-2 px-4 text-xs leading-normal text-white cursor-pointer">
