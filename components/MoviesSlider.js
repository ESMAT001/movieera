...
function MoviesSlider({ movies, movieRefs, destroyAndChange }) {
    return (
        <div className="w-screen px-10 sm:px-16 relative">
            ...
            <div className="flex flex-row flex-nowrap h-48 xl:h-60 2xl:h-72 w-full items-center space-x-6 custom-scrollbar overflow-x-scroll  mt-4 sm:mt-6 mb-10 px-5 pb-5 ">
